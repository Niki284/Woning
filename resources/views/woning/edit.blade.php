        ...
        <form action="/dashboard/woning/update/{{$woningHuis->id}}" enctype="multipart/form-data" method="POST" class="form__categorie">
            ...
            <div class=" form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rooms" name="rooms" value="{{$woningHuis->rooms}}">
                </div>
                <div class="form-group">
                    <label for="image">Image</label>
                    <input type="file" class="form-control" id="image" name="image" value="{{$woningHuis->image}}">
                </div>
                <div class="form-group">
                    <label for="grootte">Galery</label>
