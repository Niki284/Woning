...
use App\Http\Controllers\BouwtechnischController;
...
Route::middleware(['admin'])->prefix('dashboard')->group(function () {
    ...
    Route::delete('/technisch/{id}', [TechnischController::class, 'destroy'])->middleware('auth')->name('technisch.destroy');
    // Route::delete('/woning/{id}/deletetechnisch/{id}', [TechnischController::class, 'destroy'])->middleware('auth')->name('technisch.destroy');
    ...
    Route::get('/woning/{id}/editindeling', [IndelingController::class, 'edit'])->middleware('auth')->name('indeling.edit');
    Route::put('/indeling/{id}/update', [IndelingController::class, 'update'])->middleware('auth')->name('indeling.update');
    Route::delete('/indeling/{id}', [IndelingController::class, 'destroy'])->middleware('auth')->name('indeling.destroy');
    ...
    // Bouwtechnisch
    Route::resource('/bouwtechnisch', BouwtechnischController::class)->only(['index', 'show', 'create', 'store']);
    Route::get('/woning/{id}/addbouwtechnisch', [BouwtechnischController::class, 'create'])->middleware('auth');
    Route::get('/woning/{id}/editbouwtechnisch', [BouwtechnischController::class, 'edit'])->middleware('auth')->name('bouwtechnisch.edit');
    Route::put('/bouwtechnisch/{id}/update', [BouwtechnischController::class, 'update'])->middleware('auth')->name('bouwtechnisch.update');
    
    Route::delete('/woning/{id}/deletebouwtechnisch', [BouwtechnischController::class, 'destroy'])->middleware('auth')->name('bouwtechnisch.destroy');
    // Route::put('/bouwtechnisch/update/{bouwtechnisch}', [BouwtechnischController::class, 'update'])->middleware('auth');
    // Route::delete('/bouwtechnisch/{bouwtechnischId}', [BouwtechnischController::class, 'destroy'])->middleware('auth');
